      ...
      func: (projects) => {
        ...
        return new Promise((resolve) => {
          setTimeout(() => {
            ...
            const certificationsContainer = document.querySelector("#main > div.container > div:nth-child(4) > div > div:nth-child(2) > div > div > div:nth-child(5) > section") || document.querySelector("#main > div.container > div:nth-child(4) > div > div:nth-child(2) > div > div > div:nth-child(8) > section");
