...
import authImg from "../Assets/images/authlogin.png"
...
export default function Login() {
    ...
    return (
        <div className="container max-width">
            <div className="row align-items-center vh-100">
                ...
                <div className="col-md-6 auth-form">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form-container">
                        ...
                        <ButtonWithStyles type="submit">Sign In</ButtonWithStyles>
            ...
            <p className="toggleUrl">Don't have an account? <Link to="/signup">Sign up</Link></p>
        </div>
    );
}